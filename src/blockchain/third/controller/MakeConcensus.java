...
public class MakeConcensus {
	...
	public static void ackRequest(boolean isAck) {
		...
		broadcast(BROADCASTTYPY.SENDRESPOSE, s_msg.toString());
	...
	public static void broadcast(BROADCASTTYPY type, String str) {
		...
		case SENDSPEAKERID:
			...
			break;
		case FINALBLOCK:
			BroadCast sendFinalBlock = new BroadCast(
	...
	public static void listen() {
		...
		t6.start();
		// Listener responseListnener4 = new
		// Listener(GlobalVariable.sendBlockPort);
		// Narc
